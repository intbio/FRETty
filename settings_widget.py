...
class SettingsWidget(QtGui.QWidget):
    def __init__(self,workdir,parent=None):
        ...
        text=QtGui.QLabel('Thresh Donor:')
        mainLayout.addWidget(text)
